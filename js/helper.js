...
var HTMLcontactGeneric = '<li class="flex-item"><span class="orange-text"></span><span class="white-text">%data%</span></li>'; // temp removed %contacts% from this line
...
var HTMLworkMsg = '<span class="work-message">%data%</span>'; //added this
